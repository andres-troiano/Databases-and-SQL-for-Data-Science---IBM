...
--OJO! Un inner join se puede escribir como JOIN o como INNER JOIN. Es lo mismo, pero el segundo es más claro.
...
--OJO: acá no hace falta el paréntesis en el ON
select E.EMP_ID,E.L_NAME,E.DEP_ID,D.DEP_NAME
	from EMPLOYEES AS E 
	LEFT OUTER JOIN DEPARTMENTS AS D ON E.DEP_ID=D.DEPT_ID_DEP 
	AND YEAR(E.B_DATE) < 1980
;
--Query 3A: Perform a Full Join on the EMPLOYEES and DEPARTMENT tables and
